...
from TiendaEquipo.views import home, redireccion, prueba, nuevo_cliente, lista_clientes, busqueda_clientes, modificar_cliente, eliminar_cliente, proveedores, eliminar_proveedor, nuevo_producto, inventario, productos, modificar_producto, eliminar_producto, ventas, eliminar_venta
