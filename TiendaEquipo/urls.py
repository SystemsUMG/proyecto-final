...
from TiendaEquipo.views import nuevo_cliente, home, prueba, lista_clientes, busqueda_clientes, modificar_cliente, eliminar_cliente, redireccion, proveedores, inventario, nuevo_producto
